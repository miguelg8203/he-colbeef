...
def init_db():
    ...
    if not db.query(Observacion).first():
        obs_default = [
            ("DESCANSO",                  0.0, False),
            ("DESCANSO FESTIVO",          0.0, False),
            ("INCAPACIDAD",               0.0, False),
            ("PERMISO",                   0.0, False),
            ("DIA DE LA FAMILIA",         0.0, False),
            ("CAPACITACION ALTURAS",      8.0, True),
            ("DIA COMPENSATORIO",         8.0, True),
            ("RENUNCIA",                  0.0, False),
            ("DESCANSO POR CULTO",        0.0, False),
            ("LICENCIA POR LUTO",         0.0, False),
            ("AUSENCIA INJUSTIFICADA",    0.0, False),
            ("PERMISO JURADO VOTACION",   0.0, False),
            ("CITA MEDICA",               0.0, True),
            ("DISPONIBILIDAD",            0.0, True),
            ("VACACIONES",                0.0, False),
            ("VOTACION",                  0.0, False),
            ("REUNION",                   4.0, True),
        ]
